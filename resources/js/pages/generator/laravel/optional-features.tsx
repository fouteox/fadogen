            ...
            <CheckboxGroup>
                <CheckboxField>
                    <Checkbox
                        ...
                        onChange={(checked) => handleFeatureChange('schedule', checked)}
                    />
                    <Label>Task Scheduling</Label>
                </CheckboxField>
                <CheckboxField className={clsx(isFeatureAutoDetected('reverb') && 'rounded-md border border-blue-500 p-1 dark:border-blue-500')}>
                    <Checkbox
                        name="features"
                        value="reverb"
                        checked={data.features.includes('reverb')}
                        onChange={(checked) => handleFeatureChange('reverb', checked)}
                    />
                    <Label>Reverb</Label>
                </CheckboxField>
                <CheckboxField className={clsx(isFeatureAutoDetected('octane') && 'rounded-md border border-blue-500 p-1 dark:border-blue-500')}>
                    <Checkbox
                        name="features"
                        value="octane"
                        checked={data.features.includes('octane')}
                        onChange={(checked) => handleFeatureChange('octane', checked)}
                    />
